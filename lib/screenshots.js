...
(function () {
  ...
  Screenshots.prototype.compare = function (options, callback) {
    ...
    var
      ...
      commandLineUsage =  options.commandLineUsage || true,
      files = [];
    ...
    walker.on("end", function () {
      ...
      if (outputFormat === "json") {
        saveJSONFile(source + currentRelease + "-" + previousRelease + "-diff.json", files, callback);
        ...
        saveHTMLFile(source + currentRelease + "-" + previousRelease + "-diff.html", htmlData, callback);
      }
    });
  };
